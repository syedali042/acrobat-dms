        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h3 class="card-title"> <?php  echo $_GET['subdeptname'];?> Detail</h3>
                ...
                <table class="table datatable-pagination">
                    ...
                    <tbody>
                    <?php
                    $subdeptname=$_GET['subdeptname'];
                    $sele = mysqli_query($con, "SELECT * FROM subdepartments WHERE  subdept_name='$subdeptname'");
                    $cnt=1;
